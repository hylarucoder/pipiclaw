...
export class SandboxIframe extends HTMLElement {
	 ...
	 */
	public sandboxUrlProvider?: SandboxUrlProvider;
...
if (!customElements.get("sandbox-iframe")) {
	customElements.define("sandbox-iframe", SandboxIframe);
}
