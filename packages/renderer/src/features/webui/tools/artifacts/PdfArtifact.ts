		...
		return html`
			<div class="flex items-center gap-1">
				<button
					type="button"
					@click=${() => {
						this.download(this.decodeBase64(), this.filename, "application/pdf");
					}}
...
if (!customElements.get("pdf-artifact")) {
	customElements.define("pdf-artifact", PdfArtifact);
}
